...
set(known_gpu_archs "20 21(20) 30 35 50 60 61")
...
function(detect_installed_gpus out_variable)
  if(NOT cuda_gpu_detect_output)
    ...
    message(STATUS "__nvcc_res: ${__nvcc_res} __nvcc_out: ${__nvcc_out} ")
...
function(select_nvcc_arch_flags out_variable)
  # List of arch names
  set(__archs_names "Fermi" "Kepler" "Maxwell" "Pascal" "All")
  ...
  foreach(__arch ${__cuda_arch_bin})
    if(__arch MATCHES "([0-9]+)\\(([0-9]+)\\)")
      message(STATUS "${__arch} match regex")
      # User explicitly specified PTX for the concrete BIN
      list(APPEND __nvcc_flags -gencode arch=compute_${CMAKE_MATCH_2},code=sm_${CMAKE_MATCH_1})
      list(APPEND __nvcc_archs_readable sm_${CMAKE_MATCH_1})
    else()
      message(STATUS "${__arch} does not match regex")
...
list(APPEND Bsy_INCLUDE_DIRS PUBLIC ${CUDA_INCLUDE_DIRS})
list(APPEND Bsy_LINKER_LIBS PUBLIC ${CUDA_CUDART_LIBRARY}
...
if(USE_CUDNN)
  detect_cudnn()
  if(HAVE_CUDNN)
    list(APPEND Bsy_DEFINITIONS PUBLIC -DUSE_CUDNN)
    list(APPEND Bsy_INCLUDE_DIRS PUBLIC ${CUDNN_INCLUDE})
    list(APPEND Bsy_LINKER_LIBS PUBLIC ${CUDNN_LIBRARY})
  endif()
endif()
...
message(STATUS "add ${NVCC_FLAGS_EXTRA} to CUDA_NVCC_FLAGS")
...
# Usage:
#   cuda_compile(<objlist_variable> <cuda_files>)
macro(bsy_cuda_compile objlist_variable)
